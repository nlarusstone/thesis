...
We define our \textit{objective} function to be the sum of that loss and a \texit{regularization term}, which is a constant times the length of the rule list.
